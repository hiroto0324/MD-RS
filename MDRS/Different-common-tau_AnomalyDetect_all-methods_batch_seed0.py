    ...
    for iteration_idx, tau in enumerate(tau_list):
        ...
        for filename in os.listdir(folder_path):
            ...
            if match:
                ...
                np.savetxt(os.path.join(result_path, filename.replace(".txt", f"_{method}_fixed-tau{iteration_idx}.txt")), anomaly_score)
                ...
                plt.savefig(os.path.join(plot_path, filename.replace(".txt", f"_{method}_fixed-tau{iteration_idx}.png")))
                plt.close()

        time_path = f'../UCR_Anomaly_FullData/analysis/runtime_{method}_fixed-tau{iteration_idx}.csv'
