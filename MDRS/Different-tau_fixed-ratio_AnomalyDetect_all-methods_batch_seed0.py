...
if __name__ == "__main__":
    ...
    for iteration_idx, tau in enumerate(tau_list):
        ...
        param['tau'][int(param['Nx'] * (1 - mix_ratio)):] = tau
        ...
        result_path = f'../UCR_Anomaly_FullData/results/Reservoir/fixed-tau'
        plot_path = f'../UCR_Anomaly_FullData/plots/Reservoir/fixed-tau'
        ...
        for filename in os.listdir(folder_path):
            ...
            if match:
                ...
                np.savetxt(os.path.join(result_path, filename.replace(".txt", f"_{method}_fixed-ratio{iteration_idx}.txt")), anomaly_score)
                ...
                plt.savefig(os.path.join(plot_path, filename.replace(".txt", f"_{method}_fixed-ratio{iteration_idx}.png")))
                plt.close()

        time_path = f'../UCR_Anomaly_FullData/analysis/runtime_{method}_fixed-ratio{iteration_idx}.csv'
