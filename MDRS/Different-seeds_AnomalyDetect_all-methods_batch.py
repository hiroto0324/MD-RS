...
if __name__ == "__main__":
    ...
    for iteration_idx in range(10):
        ...
        result_path = f'../UCR_Anomaly_FullData/results/Reservoir/{iteration_idx}'
        plot_path = f'../UCR_Anomaly_FullData/plots/Reservoir/{iteration_idx}'
        ...
        time_path = f'../UCR_Anomaly_FullData/analysis/runtime_{method}_{iteration_idx}.csv'
